...
API_ID = int(getenv("API_ID", "24794129"))
API_HASH = getenv("API_HASH", "2ec4de43db422d8edd660613dedac2ed")
...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1001575224138"))

# A name for your Music bot.
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "Music_Bot")

# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "5589515550").split())
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/KartikRajOfficials/Scalingo",
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/loveandaffectionstatus"
)  # Example:- https://t.me/TheYukki
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/Global_Chat_group_1"
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://t.me/KartikRajofficial")
...
# Images
START_IMG_URL = getenv("START_IMG_URL", "https://te.legra.ph/file/884938536fbbdbcb72732.jpg")
